...
describe("fileFinder(directories, targetFile)", () => {
  ...
  context("when the file is not found in the directories", () => {
    it("should return false", () => {
      expect(fileFinder(desktop, "never_gonna_give_you_up.flac")).to.equal(
        false
      );
...
describe("pathFinder(directories, targetFile)", () => {
  ...
  context("when the file is found in the directories", () => {
    it("should return the path", () => {
      expect(pathFinder(desktop, "app_academy_logo.svg")).to.equal(
        "/images/app_academy_logo.svg"
      );
      expect(pathFinder(desktop, "everlong.flac")).to.equal(
        "/music/genres/rock/everlong.flac"
      );
  ...
  context("when the file is not found in the directories", () => {
    it("should return null", () => {
      expect(pathFinder(desktop, "never_gonna_give_you_up.flac")).to.equal(
        null
      );
