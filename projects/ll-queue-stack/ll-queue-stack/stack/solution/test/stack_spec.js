...
describe("Stack", () => {
  ...
  describe("Stack Methods", () => {
    ...
    describe("push", () => {
      ...
      it("Should reassign the top pointer when a new node is added to the top of an empty stack", () => {
        stack.push("A");
        expect(stack.top.value).to.equal("A");
      });

      it("Should reassign top pointer when new nodes are added to the top of the stack of size one or greater", () => {
        stack.push("A");
        stack.push("B");
